---
name: tracking-and-returns
description: "Real-time shipment tracking and returns demo powered by AfterShip. Use when a user pastes a tracking number, asks about delivery/shipping status, or a merchant wants to preview the AfterShip Returns Center for their store. Supports 1,300+ carriers with automatic detection."
license: MIT
compatibility: claude-code
metadata:
  author: AfterShip
  version: "1.0.0"
  tags: [tracking, shipping, returns, ecommerce, aftership, logistics, delivery]
---

# AfterShip Tracking & Returns — Official Skill

> **This is the official AfterShip skill**, published and maintained by [AfterShip](https://www.aftership.com).
